...
- 초기 구성은 Public EC2 ASG `min=1`, `desired=1`, `max=3`, NAT Gateway 미사용, Private RDS Single-AZ로 시작한다. EC2 인바운드는 ALB 보안 그룹에서만 허용하고, Private EC2 또는 RDS Multi-AZ 전환은 비용·가용성 합의 후 진행한다.
